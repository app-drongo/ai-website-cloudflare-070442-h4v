...
export default function Hero({
  badge = 'Trusted by 26M+ Internet Properties',
  title = 'Supercharge your website with',
  titleHighlight = "Cloudflare's Global Network",
  description = 'Accelerate and secure your applications with our edge computing platform. Get lightning-fast performance, unbreakable security, and 99.99% uptime for your business-critical websites.',
  features = [
  ...
  imageAlt = 'Cloudflare Network Dashboard',
  statsLabel1 = 'Global Reach',
  statsValue1 = '275+ Cities',
  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-background">
      {/* Cloudflare-inspired gradient and pattern */}
