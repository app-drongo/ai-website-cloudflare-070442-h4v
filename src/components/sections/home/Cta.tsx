...
export default function Cta({
  ...
  mainTitle = 'Accelerate Your Website with',
  mainTitleHighlight = "Cloudflare's Global Network",
  description = "Join millions of websites powered by Cloudflare's lightning-fast CDN, advanced security, and 99.99% uptime guarantee. Experience the difference enterprise-grade infrastructure makes.",
  primaryCTA = 'Start Free Trial',
  primaryCTAHref = '/temp',
  secondaryCTA = 'View Pricing',
  secondaryCTAHref = '/temp',
  trustText = 'Trusted by 26+ million internet properties worldwide',
  stat1Value = '26M+',
  stat1Label = 'Websites Protected',
  stat2Value = '99.99%',
  stat2Label = 'Uptime SLA',
  stat3Value = '310+',
  stat3Label = 'Global Data Centers',
  stat4Value = '55ms',
  stat4Label = 'Avg Response Time',
  feature1Title = 'Free SSL Certificate',
  feature1Description = 'Automatic HTTPS encryption for all domains',
  feature2Title = 'DDoS Protection',
  feature2Description = 'Advanced threat detection and mitigation',
  feature3Title = 'Global CDN',
  feature3Description = 'Content delivery from 310+ edge locations',
}: CTAProps) {
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        {/* Main CTA */}
        <Card className="border bg-card/80 backdrop-blur-sm shadow-2xl shadow-primary/5 overflow-hidden">
